  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "mohitpurohit020@gmail.com",
      href: "mailto:mohitpurohit020@gmail.com",
    },
    {
      icon: Phone,
      label: "Phone",
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <Card>
                ...
                <CardContent>
                  <form
                    action="https://formspree.io/f/mgvzlgyl"
                    method="POST"
                    className="space-y-6"
                  >
                    <input
                      type="hidden"
                      name="_next"
                      value="https://mohitwebport.vercel.app/thank-you"
                    />
